...
GRUPOS = {
    ...
    "F": ["Japón 🇯🇵", "Arabia Saudí 🇸🇦", "Perú 🇵🇪", "Rumania 🇷🇴"],
...
CALENDARIO_GRUPOS = [
    # ─── GRUPO A ───
    ("México 🇲🇽", "Sudáfrica 🇿🇦", "Grupo A", "2026-06-11", "Ciudad de México"),
    ("Corea del Sur 🇰🇷", "República Checa 🇨🇿", "Grupo A", "2026-06-11", "Guadalajara"),
    ("Sudáfrica 🇿🇦", "República Checa 🇨🇿", "Grupo A", "2026-06-18", "Atlanta"),
    ("México 🇲🇽", "Corea del Sur 🇰🇷", "Grupo A", "2026-06-18", "Guadalajara"),
    ("México 🇲🇽", "República Checa 🇨🇿", "Grupo A", "2026-06-24", "Ciudad de México"),
    ("Sudáfrica 🇿🇦", "Corea del Sur 🇰🇷", "Grupo A", "2026-06-24", "Dallas"),
    # ─── GRUPO B ───
    ("Canadá 🇨🇦", "Bosnia y Herzegovina 🇧🇦", "Grupo B", "2026-06-12", "Toronto"),
    ("Qatar 🇶🇦", "Suiza 🇨🇭", "Grupo B", "2026-06-12", "Vancouver"),
    ("Bosnia y Herzegovina 🇧🇦", "Suiza 🇨🇭", "Grupo B", "2026-06-18", "Houston"),
    ("Canadá 🇨🇦", "Qatar 🇶🇦", "Grupo B", "2026-06-18", "Toronto"),
    ("Canadá 🇨🇦", "Suiza 🇨🇭", "Grupo B", "2026-06-24", "Vancouver"),
    ("Bosnia y Herzegovina 🇧🇦", "Qatar 🇶🇦", "Grupo B", "2026-06-24", "Kansas City"),
    # ─── GRUPO C ───
    ("Brasil 🇧🇷", "Haití 🇭🇹", "Grupo C", "2026-06-12", "Los Angeles"),
    ("Marruecos 🇲🇦", "Escocia 🏴󠁧󠁢󠁳󠁣󠁴󠁿", "Grupo C", "2026-06-12", "Nueva York"),
    ("Brasil 🇧🇷", "Marruecos 🇲🇦", "Grupo C", "2026-06-19", "Los Angeles"),
    ("Escocia 🏴󠁧󠁢󠁳󠁣󠁴󠁿", "Haití 🇭🇹", "Grupo C", "2026-06-19", "Philadelphia"),
    ("Brasil 🇧🇷", "Escocia 🏴󠁧󠁢󠁳󠁣󠁴󠁿", "Grupo C", "2026-06-25", "San Francisco"),
    ("Haití 🇭🇹", "Marruecos 🇲🇦", "Grupo C", "2026-06-25", "Miami"),
    # ─── GRUPO D ───
    ("Estados Unidos 🇺🇸", "Paraguay 🇵🇾", "Grupo D", "2026-06-13", "Dallas"),
    ("Australia 🇦🇺", "Turquía 🇹🇷", "Grupo D", "2026-06-13", "Kansas City"),
    ("Estados Unidos 🇺🇸", "Australia 🇦🇺", "Grupo D", "2026-06-19", "New York"),
    ("Paraguay 🇵🇾", "Turquía 🇹🇷", "Grupo D", "2026-06-19", "Houston"),
    ("Estados Unidos 🇺🇸", "Turquía 🇹🇷", "Grupo D", "2026-06-25", "Miami"),
    ...
    # ─── GRUPO F ───
    ("Japón 🇯🇵", "Perú 🇵🇪", "Grupo F", "2026-06-14", "Seattle"),
    ("Arabia Saudí 🇸🇦", "Rumania 🇷🇴", "Grupo F", "2026-06-14", "Miami"),
    ("Japón 🇯🇵", "Arabia Saudí 🇸🇦", "Grupo F", "2026-06-20", "Los Angeles"),
    ("Perú 🇵🇪", "Rumania 🇷🇴", "Grupo F", "2026-06-20", "San Francisco"),
    ("Japón 🇯🇵", "Rumania 🇷🇴", "Grupo F", "2026-06-26", "Boston"),
    ("Perú 🇵🇪", "Arabia Saudí 🇸🇦", "Grupo F", "2026-06-26", "Kansas City"),
    # ─── GRUPO G ───
    ("Bélgica 🇧🇪", "Nueva Zelanda 🇳🇿", "Grupo G", "2026-06-14", "Atlanta"),
    ("Irán 🇮🇷", "Egipto 🇪🇬", "Grupo G", "2026-06-14", "Dallas"),
    ("Bélgica 🇧🇪", "Irán 🇮🇷", "Grupo G", "2026-06-21", "Nueva York"),
    ("Egipto 🇪🇬", "Nueva Zelanda 🇳🇿", "Grupo G", "2026-06-21", "Miami"),
    ("Bélgica 🇧🇪", "Egipto 🇪🇬", "Grupo G", "2026-06-27", "Philadelphia"),
    ("Irán 🇮🇷", "Nueva Zelanda 🇳🇿", "Grupo G", "2026-06-27", "Boston"),
    # ─── GRUPO H ───
    ("España 🇪🇸", "Cabo Verde 🇨🇻", "Grupo H", "2026-06-15", "San Francisco"),
    ("Uruguay 🇺🇾", "Arabia Saudí 🇸🇦", "Grupo H", "2026-06-15", "Seattle"),
    ("España 🇪🇸", "Uruguay 🇺🇾", "Grupo H", "2026-06-21", "Los Angeles"),
    ("Cabo Verde 🇨🇻", "Arabia Saudí 🇸🇦", "Grupo H", "2026-06-21", "Guadalajara"),
    ("España 🇪🇸", "Arabia Saudí 🇸🇦", "Grupo H", "2026-06-27", "Dallas"),
    ...
    ("Colombia 🇨🇴", "Uzbekistán 🇺🇿", "Grupo K", "2026-06-16", "Houston"),
    ("Portugal 🇵🇹", "Colombia 🇨🇴", "Grupo K", "2026-06-23", "Kansas City"),
    ("Jamaica 🇯🇲", "Uzbekistán 🇺🇿", "Grupo K", "2026-06-23", "Atlanta"),
    ("Portugal 🇵🇹", "Uzbekistán 🇺🇿", "Grupo K", "2026-06-28", "Philadelphia"),
    ("Colombia 🇨🇴", "Jamaica 🇯🇲", "Grupo K", "2026-06-28", "Dallas"),
    # ─── GRUPO L ───
    ("Inglaterra 🏴󠁧󠁢󠁥󠁮󠁧󠁿", "Ghana 🇬🇭", "Grupo L", "2026-06-17", "Nueva York"),
    ("Croacia 🇭🇷", "Panamá 🇵🇦", "Grupo L", "2026-06-17", "San Francisco"),
    ("Inglaterra 🏴󠁧󠁢󠁥󠁮󠁧󠁿", "Croacia 🇭🇷", "Grupo L", "2026-06-23", "Philadelphia"),
    ("Panamá 🇵🇦", "Ghana 🇬🇭", "Grupo L", "2026-06-23", "Houston"),
    ("Inglaterra 🏴󠁧󠁢󠁥󠁮󠁧󠁿", "Panamá 🇵🇦", "Grupo L", "2026-06-28", "Boston"),
